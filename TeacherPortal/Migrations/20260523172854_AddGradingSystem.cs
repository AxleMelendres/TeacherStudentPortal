        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleStartTime = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ScheduleEndTime = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GradeColumnId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GradeWeightId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
                    Period = table.Column<string>(type: "text", nullable: false),
                    ActivityWeight = table.Column<decimal>(type: "numeric", nullable: false),
                    QuizWeight = table.Column<decimal>(type: "numeric", nullable: false),
                    ExamWeight = table.Column<decimal>(type: "numeric", nullable: false),
                    ProjectWeight = table.Column<decimal>(type: "numeric", nullable: false),
                    MidtermWeight = table.Column<decimal>(type: "numeric", nullable: false),
                    FinalsWeight = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeWeights", x => x.GradeWeightId);
                    table.ForeignKey(
                        name: "FK_GradeWeights_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "SubjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubjectScheduleId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasExcuseLetter = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "integer", nullable: false),
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
                    Quiz = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    Activity = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    Assignment = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    MidtermExam = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    FinalExam = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentSubjects_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "SectionId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentGrades_GradeColumns_GradeColumnId",
                        column: x => x.GradeColumnId,
                        principalTable: "GradeColumns",
                        principalColumn: "GradeColumnId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_SubjectId_StudentId_AttendanceDate",
                table: "Attendances",
                columns: new[] { "SubjectId", "StudentId", "AttendanceDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeWeights_SubjectId",
                table: "GradeWeights",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Sections_TeacherId_SectionName",
                table: "Sections",
                columns: new[] { "TeacherId", "SectionName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentGrades_GradeColumnId",
                table: "StudentGrades",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjects_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_TeacherId_SubjectCode",
                table: "Subjects",
                columns: new[] { "TeacherId", "SubjectCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubjectSchedules_SubjectId_Day_StartTime",
                table: "SubjectSchedules",
                columns: new[] { "SubjectId", "Day", "StartTime" },
                unique: true);
